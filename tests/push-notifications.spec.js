...
const SITE = process.env.SITE_URL || 'https://messenger.closer.click'
 ...
 *   1. El handler de push del Service Worker desplegado (closer-click-push-sw.js
...
test('SW: el handler de push desplegado dispara cc-push-ring', async () => {
  ...
  // El handler de push (solo existe en closer-click-push-sw.js) debe haber
