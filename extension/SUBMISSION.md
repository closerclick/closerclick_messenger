...
- [ ] `chrome://extensions/` → "Pack extension" produces a valid `.zip` from this folder, OR run:
      ```bash
      cd closerclick_messenger_extension
...
- Update the README + the landing page (`closerclick/src/App.vue`) to point to that URL instead of the GitHub repo install instructions.
